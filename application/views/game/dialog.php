...
<div class="box" id="box">		
	<div class="head">
		...
		<div class="dialog-question-tag" id="qstn_tag" style="height: inherit; font-family: inherit; display: inline-block; float: right; margin-right: 20px; font-size: inherit; color: #ffffff"><?php echo $tag ?></div>
	</div>
