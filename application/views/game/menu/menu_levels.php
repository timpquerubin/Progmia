			...
			<div class="game-level-menu-container">
				...
				<div class="row">
					<div class="title-header">
						...
						<img class="img-responsive stg-img" src="<?php echo base_url();?>assets/images/STAGES/<?php echo $info['STG_FILENAME'];?>"><h1 id="title"><?php echo $info['STG_DESCRIPTION']; ?></h1><?php } ?>
					</div>
				</div>
				<?php $array = array(); ?>
