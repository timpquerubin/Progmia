			...
			<div class="panel-heading"><i class="fa fa-list-ol" aria-hidden="true"></i>Avatar List</div>
			<div class="row">
				<a href="<?php echo base_url(); ?>Dashboard/add_avatar" class="btn btn-default" >Add Avatar</a>
			</div>
