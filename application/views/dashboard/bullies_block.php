				...
				<?php foreach($bully_list as $bully) { ?>
					...
					<tr>
						...
						<td>
							...
							<button class="btn btn-default" type="button" onclick="delete_bully('<?php echo $bully['id'] ?>')">D</button>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		delete_bully = function(blyId) {

			$.ajax({
				type: 'post',
				url: "<?php echo base_url(); ?>dashboard/delete_bully",
				data: {bly_id: blyId},
				success: function(data) {
