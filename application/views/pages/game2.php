	...
	<div class="menu collapse in" id="menu">
		<div class="row">
			<nav class="main-nav">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				    <h2 class="lvl-name"><?php echo $level_info['LVL_NAME']; ?></h2>
				</div>
				...
				<div class="code-area-container wrapper-1">
					...
					<div class="row code_area">
						...
						<div class="code-area-container border-custom col-lg-11 col-md-11 col-sm-11 col-xs-11">
							<textarea class="code_area" id="code_area" name="code_area" rows="10" onscroll="document.getElementById('textarea1').scrollTop = this.scrollTop;" autocorrect="off" spellcheck="false"></textarea>
						</div>
					</div>
	...
	Player = function(id, x, y, width, height, image)
	{
		...
		self.updatePosition = function()
		{
			...
			if(isError)
			{
				...
				// alert('error: Character Collision');
				$("#finish-modal").css("display", "block");
