...
<html>
	...
	<body>
        <div id="loading" class="container-fluid"">
            <div class="wrapper">
                ...
                <div class="row">
                    <p id="dos-donts" style="font-size:1.7vw;color:#ffffff;text-shadow: 0px 2px 2px #000;text-align: center;margin:30px auto 0 auto;word-spacing: .7vw;"></p>
                </div>
            </div>  
        </div>
        <nav id="mainNav">
    ...
    <div id="settings-modal" class="modal fade" style="display: none;">
        ...
        <script>
            ...
            var myArray = [
              "Do separate your code into lines; it also makes it easier to read.",
              "Don't skip a blank line between your lines of code.",
              "Don't declare two variables in the same line."
            ];


            var paragraph = document.getElementById("dos-donts");
            var randomItem = myArray[Math.floor(Math.random()*myArray.length)];
            var text = document.createTextNode(randomItem);

            paragraph.textContent = randomItem;

            // document.getElementById("dos-donts").innerHTML = randomItem;
