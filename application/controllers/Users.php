	...
	class Users extends CI_Controller
	{
		public function register()
		{
			...
			if(!empty($errors))
			{
                ...
                $id_gen = $this->User_model->gen_id();
				$reg_res = $this->User_model->register($this->User_model->gen_id());
				$data["success"] = true;
		...
		public function login()
		{
			...
			else
			{
				if ($user == null && $pass == null) {
					$this->session->set_flashdata('user_loggedfailed', '<i class="fa fa-exclamation"></i>Please fill in Username and Password.');
					redirect('login');
				}
				if ($user == null) {
					$this->session->set_flashdata('user_loggedfailed', '<i class="fa fa-exclamation"></i>Please fill in Username.');
					redirect('login');
				}
				if ($pass == null) {
					$this->session->set_flashdata('user_loggedfailed', '<i class="fa fa-exclamation"></i>Please fill in Password.');
					redirect('login');
				}
				else
				{
					$this->session->set_flashdata('user_loggedfailed', '<i class="fa fa-exclamation"></i>Invalid Username/Password');
					redirect('login');
				}
			}
		}
