...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2018 at 11:13 AM
...
(5, NULL, '1', 'fa5953f5d77703da5a23670a95729953', 400, NULL, '0000-00-00 00:00:00'),
(6, NULL, '1', '510fb9ed3a51f8ede848403e79aeca1a', 300, NULL, '0000-00-00 00:00:00'),
(7, NULL, '1', '510fb9ed3a51f8ede848403e79aeca1a', 300, NULL, '0000-00-00 00:00:00'),
(8, NULL, '1', '510fb9ed3a51f8ede848403e79aeca1a', 400, NULL, '0000-00-00 00:00:00');
...
--
ALTER TABLE `player`
  ADD PRIMARY KEY (`USER_ID`,`AVTR_ID`),
  ADD KEY `AVATAR_ID` (`AVTR_ID`),
